<template>
  <div class="my-bg flex flex-col h-screen w-screen max-w-full items-center justify-center text-white relative">
    ...
    <a class="w-3/12 sm:w-full md:w-full h-auto z-20 flex items-center justify-center"
      href="https://www.instagram.com/hook.ia/" target="_blank" title="Hook.ia Instagram profile">
      <img src="./assets/logo.png">
    </a>
    <form class="flex items-center justify-center flex-col z-20 w-full px-24 lg:px-0">
      <!-- <div class="mb-6">
        <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Email address</label>
        <input type="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="john.doe@company.com" required>
    </div>  -->
      <div class="mb-6">
        <h1 class="text-2xl">Do you want to participate in our next <span class="font-bold">Weekly Online
            Magazine</span>?</h1>
      </div>
      <div class="mb-6 sm:w-full lg:w-6/12 w-6/12">
        ...
        <div class="relative">
          <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
            <svg fill="none" class="w-5 h-5 text-white dark:text-white" stroke="currentColor" stroke-width="1.5"
